...
namespace Microsoft.BotBuilderSamples
{
    public class ReviewSelectionDialog : ComponentDialog
    {
        ...
        private readonly string[] _exerciseOptions = new string[]
        {
            "School",
            "Dentist",
            "Bus",
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (list.Count is 0)
            {
                message = $"Please choose an exercise to review, or `{DoneOption}` to finish.";
            }
            else
            {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (!done)
            {
                // If they chose an exercise, add it to the list.
